...
export default async function CustomerProfilePage({params: {id}}) {
    ...
    <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-28 lg:my-0 text-black dark:text-white">
      ...
      <div id="profile"
        ...
        <div className="p-4 md:p-12 text-center lg:text-left">
          ...
          >
            <Image width={200} height={200} src={customer.image ? customer.image : "/Avatar.png"} alt='avatar'/>
          </div>

          <h1 className="text-3xl font-bold pt-8 lg:pt-0 uppercase dark:text-white text-black">{customer.name}</h1>
          <div className="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-green-500 opacity-25"></div>
            ...
            <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
             <Earth className='h-4 w-8  text-green-700 pr-4'/>
              Your Location - {customer.address}
            </p>
            <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
            ...
            <p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
              ...
              Member since: {ConvertIsoDateToNormal(customer.createdAt)}
            </p>         
            <div className="pt-12 pb-8">
              <Link href={`/profile/update/${id}`} className="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
				        Edit Profile
				      </Link>
            </div>
          </div>
        ...
        <div className="w-full lg:w-2/5">
          ...
          <Image width={200} height={200} src={customer.image ? customer.image : "/Avatar.png"} alt='avatar' className='bg-white rounded-none lg:rounded-lg shadow-2xl hidden lg:block w-96'/>
        </div>
